...
public class pri {
	...
	public void add(){
		String data = Emp_ID +","+  First_Name +","+ Last_Name +","+ Gender +","+ E_Mail +","+ Fathers_Name +","+ Mothers_Name +","+ Date_of_Birth +","+ Age +"," + Date_of_Joining + "," +  Salary + "," + SSN + "," + Phone_No ;
			try{			
				...
				RandomAccessFile indexfile = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/index.txt","rw");
	...
	public void unPack(){
		try{
			@SuppressWarnings("resource")
			BufferedReader reader = new BufferedReader(new FileReader("/home/krishna/Desktop/Fsmini/project/humanresources.txt"));
    		String line;
                try{
	  ...
	  @SuppressWarnings("resource")
		public void priIndex(){
			...
			try {
				indexfile = new RandomAccessFile("/home/krishna/Desktop/Fsmini/index.txt","rw");
