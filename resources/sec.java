...
public class sec {
		...
		public void add(){
			...
			try{			
				RandomAccessFile recordfile = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/project/humanresources.txt","rw");
				recordfile.seek(recordfile.length());
				long pos = recordfile.getFilePointer();
				recordfile.writeBytes(data+"\n");
				recordfile.close();
								
				RandomAccessFile indexfile1 = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/index1.txt","rw");
		...
		public void priIndex(){
			...
			try {
				indexfile = new RandomAccessFile("/home/krishna/Desktop/Fsmini/index1.txt","rw");
		...
		public void sortIndex() {
		 ...
		 public void readFile(int pos) {
		            ...
		            try {
		                recordfile = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/project/humanresources.txt","rw");
		                try {
		        ...
		        public  void indexing() 
				  {
				         try{
				        RandomAccessFile recfile=new RandomAccessFile("/home/krishna/Desktop/Fsmini/project/humanresources.txt","rw");
				        
				        RandomAccessFile indexfile=new RandomAccessFile("/home/krishna/Desktop/Fsmini/index1.txt","rw");
				        String line;
	 ...
	 public void markDelete(int pos, String ssn) {
	     try {
	         RandomAccessFile recordfilee = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/project/humanresources.txt","rw");
	         @SuppressWarnings("resource")
	         RandomAccessFile indexfilee = new RandomAccessFile ("/home/krishna/Desktop/Fsmini/index1.txt","rw");
